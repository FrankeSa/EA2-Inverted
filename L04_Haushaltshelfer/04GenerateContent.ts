namespace L04_Haushaltshelfer {
    ...
    export function generateContent(_data: Data) {
        ...
        for (let category in _data) {
            ...
            let group: HTMLElement | null = null; // HTMLElement deshalb, damit goup mehrmals verwendet werden kann. Egal was die funktion liefert, es ist auf jeden Fall ein HTMLElement mit dem Wert Null. Kann dann je nach Fall HTMLSelect etc. sein.
            switch (category) {
                case "Einkäufe":
