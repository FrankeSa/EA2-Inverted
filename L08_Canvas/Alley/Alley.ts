...
namespace L08_Canvas_Alley {
    ...
    function handleLoad(_event: Event): void {
        ...
        drawBackground();
        drawSun({ x: 100, y: 75 }); //Position auf dem Canvas wird vergeben
        drawCloud({ x: 500, y: 125 }, { x: 250, y: 75 }); // in den geschweiften Klammern zwei Vektorobjekte eins für Position und eins für die Größe
    ...
    function drawSun(_position: Vector): void { // funktion erwartet die Position vom Typ Vektor
